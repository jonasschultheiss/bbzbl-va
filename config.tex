...
\newcommand{\docauthor}{Dario Grob, Bastian Büeler, Jonas Schultheiss}
\newcommand{\task}{Vertiefungsarbeit} % e.g. Modul 152/IPA/...
...
\usepackage[
  ...
  pdfkeywords={OSE, OSEDashboard, Dashboard}
]{hyperref}
